...
for img1 in comparisonImages:
    for img2 in comparisonImages:
        ...
        # Getting object positions, PHOT_FLUXFRAC-light radii, and image data
        ...
        for i in range(M):
            ...
            '''
        """
    break # Always break; if not break, reset img1,img2 = [image1,image2] to avoid processing problems
