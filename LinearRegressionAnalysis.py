...
def analyze(x,y,output_file):
    ...
    with open(output_file,'w') as g:
        ...
        g.write('# We subtract the line y = x from the data and perform linear regression on the residuals to test the null hypothesis that the slope of data is = 1\n')
